...
def performGeneralCalculations(setupData, eventData):
        ...
        if time - lastHour > hourLength:
            ...
            for hourId in range(0, len(currentHour)):
                ...
                if inoculumOnly[hourId]:
                    hourinoculum[-1].append(currentHour[hourId] / inoculumMass[hourId])
    ...
    for e in eventLog:
        ...
        if inoculumOnly[bucketId]:
            ...
            inoculumTotalNetVolume = inoculumTotalNetVolume + (e[10] / inoculumMass[bucketId])
    ...
    for index in range(0, len(eventLog)):
        ...
        if not inoculumOnly[bucketId]:
            ...
            eventLog[index][16] = ( (eventLog[index][16] * sampleMass[bucketId]) - (inoculumAverage * inoculumMass[bucketId]) ) / sampleMass[bucketId]
